      ...
      <div className="flex flex-1 justify-end md:justify-center">
        <nav className="pointer-events-auto hidden md:block">
          <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
            <li>
              <Link href="#home" className="relative block px-3 py-2 transition hover:text-teal-500 dark:hover:text-yellow-500">
            ...
            <SheetHeader>
              ...
              <SheetDescription>
                <ul className="flex flex-col bg-white/90 text-sm font-medium text-zinc-800 text-left shadow-zinc-800/5  backdrop-blur dark:bg-zinc-950 dark:text-zinc-200 dark:ring-white/10">
                  <li>
                    <Link href="#home" className="block px-3 py-2 transition hover:text-teal-500 dark:hover:text-yellow-500">
                      Home
                    </Link>
                  </li>
                  <li>
